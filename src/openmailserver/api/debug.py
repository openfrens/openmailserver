...
from openmailserver.schemas import BackupResponse, DebugReport, DnsPlanResponse, QueueEntry
...
from openmailserver.services.debug_service import config_report, debug_bundle, doctor_report
...
from openmailserver.services.queue_service import list_queue, message_trace as queue_message_trace
...
def bundle(
    ...
    status = "warn" if report["doctor"]["status"] != "ok" or report["health"]["status"] != "ok" else "ok"
